...
const Section2 = ({padding}) => {
  return (
    <section className={`relative ${padding} flex flex-col 1440:items-start 1440:py-[140px] 1440:flex-row gap-[56px] md:gap-[64px] bg-SacramentoGreen overflow-x-hidden`}>
        <div className='flex items-center'>
            ...
            <img src={home2} alt="" className='relative right-[-5rem] 1440:hidden top-[-2rem]'/>
        </div>

        <div className='grid gap-[48px] md:gap-[32px] mb-[64px] 1440:mb-0 1440:mt-[5rem]'>
