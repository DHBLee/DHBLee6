...
const Header = () => { {/* Will need to fix the styling globals setup */}
  return (
    <header className='relative'>
        ...
        <div className='px-6 absolute top-[30%] md:top-[37%] left-[50%] 1440:left-0 w-[100%]  translate-x-[-50%] 1440:translate-x-0 grid gap-8 md:gap-[38px] items-center justify-center 1440:justify-start'>
            <img src={logo} alt="" className='mx-auto 1440:mx-0'/>
            <div className=' text-white grid gap-[21px] text-center 1440:text-left'>
                <h1 className='text-[32px] md:text-[48px] 1440:headingXL tracking-[-0.4px] md:tracking-[-0.6px] leading-[40px] md:leading-[64px] font-light '>Exquisite dining<br /> since 1989</h1>
